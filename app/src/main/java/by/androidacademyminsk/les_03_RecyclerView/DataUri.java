...
public class DataUri {
    ...
    public static List<Actor> generateActors() {
        ...
        actors.add(new Actor("Robin Wright",
                Uri.parse("https://upload.wikimedia.org/wikipedia/commons/5/51/Robin_Wright_2009.jpg"),
                Uri.parse("https://upload.wikimedia.org/wikipedia/commons/4/49/Robin_Wright_%26_Sean_Penn_%28cropped%29.jpg"),
